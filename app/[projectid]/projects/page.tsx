  ...
  return (
    <article className="space-y-8 py-8">
      <header className="space-y-3">
        ...
        {project.link ? (
          <Button asChild size="sm" variant="outline">
            <Link href={project.link} target={external ? "_blank" : undefined} rel="noreferrer">
              {external ? "View on cvm-ai.com" : "Project link"}
      ...
      <section>
        ...
        <ProjectsComponent
          ProjectsToShow={projects.filter((p) => p.id !== Number(projectid))}
          showTitle={false}
        />
      </section>
    </article>
